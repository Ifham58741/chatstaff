            ...
            <div class="card-body">
              <p class="text-muted" id="msg">
                <?php if($install_allow==1) :?>
                  <div class="alert alert-success text-center"><b><i class="fa fa-check-circle"></i> Congratulation ! Your server is fully configured to install this application. Just make sure all files and folders have write permission (755 permission recommended) | <a href="https://cutt.ly/PLFZenO" target="_blank">NULLED :: Web Community</a></p></b></div>
                <?php else : ?>
